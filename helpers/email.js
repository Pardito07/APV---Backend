...
const emailRegistro = async datos => {
    ...
    .sendTransacEmail({
        ...
        htmlContent: `
            ...
            <a style="background-color:#4f46e5; font-weight:bold; color:white; padding:10px; border-radius:5px; text-decoration:none; text-transform:uppercase; margin-top:20px; margin-bottom:20px;" href="${process.env.FRONTEND_URL}/confirmar/${token}">Confirmar Cuenta</a>
...
const emailRecuperarPassword = async datos => {
    ...
    .sendTransacEmail({
        ...
        htmlContent: `
            ...
            <a style="background-color:#4f46e5; font-weight:bold; color:white; padding:10px; border-radius:5px; text-decoration:none; text-transform:uppercase; margin-top:20px; margin-bottom:20px;" href="${process.env.FRONTEND_URL}/olvide-password/${token}">Reestablecer Contraseña</a>
